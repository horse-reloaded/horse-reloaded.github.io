export default function Footer() {
  ...
  return (
    <footer className="text-gray-600 py-8 mt-16">
      <div className="container mx-auto px-4">
        <div className="flex justify-center items-center gap-4">
          <a
            href="https://github.com/horse-reloaded"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="GitHub Horse Reloaded"
          ...
          <a
            ...
            className="hover:text-indigo-500 transition-colors duration-200 hover:scale-110 transform"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
